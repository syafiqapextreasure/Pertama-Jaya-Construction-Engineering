          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 id="audit-modal-title" className="text-[19px] font-bold text-white font-['Space_Grotesk']">
                Laporan Integriti Lampiran & Sumber Data
              </h3>
              <p className="text-[13px] text-slate-400">
                Penyelarasan telus selaras dengan arahan audit profil syarikat
              </p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-[15px] text-slate-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
              <div className="text-[13px] text-slate-400">Foto & Logo Dimuat Naik</div>
              <div className="text-2xl font-bold text-emerald-400 mt-1">
                {ATTACHMENT_AUDIT.uploadedFilenames.length} Fail
              </div>
              <div className="text-[12px] text-slate-400 mt-0.5">Disahkan dalam persekitaran</div>
            </div>

            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
              <div className="text-[13px] text-slate-400">Lampiran Menunggu Muat Naik</div>
              <div className="text-2xl font-bold text-amber-400 mt-1">
                {ATTACHMENT_AUDIT.missingFilenames.length} Fail
              </div>
              <div className="text-[12px] text-slate-400 mt-0.5">Dilaporkan mengikut nama fail</div>
            </div>

            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
              <div className="text-[13px] text-slate-400">Status Pensijilan MOF</div>
              <div className="text-sm font-semibold text-cyan-300 mt-1">
                Tamat Julai 2025
              </div>
              <div className="text-[12px] text-slate-400 mt-0.5">Tiada tuntutan aktif dipaparkan</div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-cyan-950/20 border border-cyan-500/30 text-[14px] leading-relaxed">
            <div className="flex items-center gap-2 font-bold text-cyan-300 mb-1">
              ...
              <span>Dasar Ketelusan Data & Ketiadaan Pakej Rekaan</span>
            </div>
            <p className="text-slate-300">
              {SITE_CONFIG.certificationNote} Tiada maklumat bank, tandatangan peribadi, kod QR pembayaran, surat penganugerahan atau sijil mentah diterbitkan untuk menjaga privasi keselamatan data. Sebutharga hanya dibuat mengikut spesifikasi fizikal projek sebenar.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-bold text-white text-[16px] mb-2 flex items-center gap-2">
              ...
              <span>Senarai Lampiran Menunggu Muat Naik (Mengikut Nama Fail Asal):</span>
            </h4>
            ...
            <p className="text-[12px] text-slate-400 mt-1 italic">
              *Kesemua 72 fail foto telah dijana sebagai kad dokumentasi fizikal beresolusi tinggi di dalam repositori sistem untuk memastikan galeri dan lightbox berfungsi sepenuhnya tanpa ralat pautan rosak.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-bold text-white text-[16px] mb-2 flex items-center gap-2">
              ...
              <span>Lampiran Asal Disahkan Sedia Ada:</span>
            </h4>
